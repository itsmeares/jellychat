...
mise exec dotnet@9.0 -- dotnet publish "$REPO_ROOT/Jellyfin.Plugin.JellyChat.sln" -c Debug

mkdir -p "$PLUGIN_DIR"
rsync -a --delete "$REPO_ROOT/Jellyfin.Plugin.JellyChat/bin/Debug/net9.0/publish/" "$PLUGIN_DIR/"
