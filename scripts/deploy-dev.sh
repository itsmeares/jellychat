...
mise exec dotnet@10.0 -- dotnet publish "$REPO_ROOT/Jellyfin.Plugin.JellyChat.sln" -c Debug

mkdir -p "$PLUGIN_DIR"
rsync -a --delete "$REPO_ROOT/Jellyfin.Plugin.JellyChat/bin/Debug/net10.0/publish/" "$PLUGIN_DIR/"
